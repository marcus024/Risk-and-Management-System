...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "UPDATE oppassessment_table SET deleted=1 WHERE id = ?";
    $last_id = $_POST["r_id"];
    session_start();
    $encoder = $_SESSION["fullName"];
    $sql3 = "INSERT INTO history (encoder,actDesc,stat,id) VALUES ('$encoder','Opportunity Assessment','Deleted','$last_id')";
    echo $sql3;
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-success" >
                            ...
                            <p>
                                ...
                                <a href="../Froms/assOpp.php" class="btn btn-secondary">No</a>
                            </p>  
                            </div>
