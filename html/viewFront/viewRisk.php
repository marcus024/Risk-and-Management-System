<?php
include('../viewFront/h.php');
include('../viewBack/backendViewRisk.php');
?>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
                  ...
                  <label class="col-sm-5 col-form-label" for="basic-default-company">Risk Number</label>
                    <div class="col-sm-12">
                      <input
                        ...
                        readonly value="<?php echo $row["risk_num"]; ?>"
                      />
                    </div>
                </div>
                <div class="col mb-1">
              ...
              <div class="row mb-3">
                ...
                <div class="col mb-1">
                  <label class="col-sm-5 col-form-label" for="basic-default-company">Internal Factor</label>
                  <div class="col-sm-12">
                  <input 
                        style="color: #696cff;"
                        type="text" 
              ...
              <div class="row mb-3">
                ...
                <div class="col mb-1">
                  ...
                  <div class="col-sm-12">
                    <input style="color: #696cff;" readonly value="<?php echo $row["severity"]; ?>" type="text" class="form-control" id="basic-default-name" />
                  </div>
                </div>
                <div class="col mb-1">
              ...
              <div class="row mb-3">
                    ...
                    <!-- Treatment -->
                      <div class="row mb-3">
                          <label class="col-sm-9 col-form-label" for="basic-default-company">Treatment</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control" id="basic-default-name" value= "<?= $treatmentArray[$i]; ?>">
                            </div>
                      </div>
                      <!-- Start and End -->
                      <div class="row mb-3">
                          ...
                          <input type="text" class="form-control" value= "<?= $startArray[$i]; ?>" id="basic-default-name">
                          </div>
                          <div class="col mb-1">
                          <label class="col-sm-9 col-form-label" for="basic-default-company">End of Activity</label>
                          <input type="text" class="form-control" value= "<?= $endArray[$i]; ?>" id="basic-default-name">
                          </div>
                      </div>
                  </div>
                  <!-- Action Plan -->
                  <div class="col mb-1">
                    ...
                    <textarea class="form-control" id="" cols="70" rows="5.2"><?= $action_planArray[$i]; ?></textarea> 
                  </div>
                  <div class="col mb-1">
                      <!-- Responsible -->
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-12">
                          <input type="text" class="form-control" value= "<?= $responsibleArray[$i]; ?>" id="basic-default-name">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-12">
                      <input type="text" class="form-control"  value= "<?= $measureArray[$i]; ?>" id="basic-default-name">
                      </div>
                      </div>
                  </div>
              </div>
            ...
            ?>
              ...
              <div class="row justify-content-end">
                <div class="d-flex justify-content-start">
                  <!-- <a type="submit" href="../Edit/updateRisk.php?id=" class="btn btn-danger">Update</a>&nbsp; -->
